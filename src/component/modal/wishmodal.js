...
const Wishmodal = ({ open, title, content, onOk, onCancel }) => {
  return (
    <Modal
      open={open}
      onOk={onOk}
    ...
    >
      <div>
        ...
        <div className="deleteheader">
          <div style={{color:'#ffffff'}}>Wish</div>
          {/* Custom X 버튼 */}
          <button className="deletemodalbtn" onClick={onCancel}>x</button>
        </div>
        {/* 모달 내용 */}
        <div style={{display:'flex', justifyContent:'center'}}>
            <img src='/pixel/pixel-fullheart.png' alt='경고' style={{width:'30px', height:'30px', marginTop:'25px', marginRight:'15px'}}/>             
